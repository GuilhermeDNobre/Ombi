...
namespace Ombi.DependencyInjection
{
    ...
    public static class IocExtensions
    {
        ...
        public static void RegisterEngines(this IServiceCollection services)
        {
            ...
            services.AddTransient<IMovieDvrSender, RadarrDvrSender>();
            services.AddTransient<IMovieDvrSender, Radarr4KDvrSender>();
            services.AddTransient<IMovieDvrSender, DogNzbDvrSender>();
            services.AddTransient<IMovieDvrSender, CouchPotatoDvrSender>();
            services.AddTransient<IMovieDvrSenderFactory, MovieDvrSenderFactory>();
            ...
            services.AddTransient<ITvDvrSender, SonarrDvrSender>();
            services.AddTransient<ITvDvrSender, SickRageDvrSender>();
            services.AddTransient<ITvDvrSenderFactory, TvDvrSenderFactory>();
